...
export default function CaseTable() {
  ...
  const { globalFilter } = state;
    ...
    // Use the CaseTable component with your specific columns and data
<CaseTable columns={columns} data={data} />;
  return (
    <div>
      <input
        id="searchbar"
          ...
          return (
            <td {...cell.getCellProps()}>
              ...
              {cell.column.id === 'viewDetails' ? (
                <button onClick={() => openModal(row.original)}>View Details</button>
              ) : (
                cell.render('Cell')
              )}
            </td>
